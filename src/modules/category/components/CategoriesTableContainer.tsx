...
const CategoriesTableContainer = ({ tableHeaders, data, noDataMessage, setRefetchData }: any) => {
        ...
        <div className={`table_container`}>
                    ...
                    <>
                        {data?.map((item: any, index: number) => (
                            <div className="item has_logo" key={index}>
                                ...
                                <div className="column ">{item?.slug || "-"}</div>
                                ...
                                <div className="column actions actions_col">
                                    <div className="action_btn edit" onClick={(e) => { e.stopPropagation(); navigate(`/categories/create-category/${item.id}`) }}>
            ...
            {deleteModalOpen && (
                <ModalContainer small>
                    <DeleteModal id={deleteModalOpen} setModal={setDeleteModalOpen} setRefetchData={setRefetchData} route={"/category"} successMsg={"Category deleted successfully"} warningMsg={"Are you sure you want to delete this category?"} />
                </ModalContainer>
            )}
        </div>
    );
